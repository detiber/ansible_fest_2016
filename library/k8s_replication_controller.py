...
DOCUMENTATION = '''
---
module: k8s_replication_controller
short_description:
description:
version_added: "2.2"
...
options:
    name:
        required: true
        description:
            - Name of the replication_controller.
    state:
        required: false
        default: "present"
        choices: [ present, absent ]
        description:
            -  Whether the replication_controller should exist or not.
    api_version:
        required: false
        default: "v1"
        choices: [ v1 ]
    ...
    labels:
        ...
        default: None
        description:
            - A dictionary of the labels to apply to this replication_controller.
    annotations:
        required: false
        default: None
        description:
            - A dictionary of the annotations to apply to this replication_controller.
'''
EXAMPLES = '''
'''
...
def main():
    ...
    try:
        result = wrapper.replication_controller(
