...
options:
    ...
    state:
        ...
        description:
            -  Whether the namespace should exist or not.
    api_version:
        required: false
        default: "v1"
        choices: [ v1 ]
    ...
    labels:
        ...
        default: None
        description:
            - A dictionary of the labels to apply to this namespace.
    annotations:
        required: false
        default: None
        description:
            - A dictionary of the annotations to apply to this namespace.
'''
EXAMPLES = '''
'''
